...
ALLOWED_HOSTS = config(
    'ALLOWED_HOSTS',
    default='localhost,127.0.0.1,nginx,nginx-proxy,web',
...
MIDDLEWARE = [
    ...
    "utils.middleware.request_id.RequestIDMiddleware",
    "utils.middleware.audit.AuditMiddleware",
]
...
if IS_TESTING:
    # Unit i integration testovi -> SQLite
    DATABASES = {
        'default': {
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': config('DATABASE_NAME', default='uks'),
            'USER': config('DATABASE_USER', default='postgres'),
            'PASSWORD': config('DATABASE_PASSWORD', default='123456789'),
            'HOST': config('DATABASE_HOST', default='localhost'),  # Docker: 'db'
